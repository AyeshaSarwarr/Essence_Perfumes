...
function About() {
  return (
    <section className=" text-zinc-900 overflow-hidden">
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto px-6 pt-20 md:py-32">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group overflow-hidden rounded-sm shadow-2xl">
            <video 
              className="w-full md:h-[60vh] object-cover transition-transform duration-1000 group-hover:scale-105" 
              poster="/perfume.jpg" 
              autoPlay 
              loop 
              muted 
          ...
          <div className="space-y-10 md:pl-10">
            <div className="space-y-6">
              ...
              <p className="text-zinc-600 leading-8 font-light md:text-lg">
