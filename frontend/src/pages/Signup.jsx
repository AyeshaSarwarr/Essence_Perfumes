...
function Signup() {
  ...
  try {
   ...
   const response = await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/user/signup`, {name: form.name, email: form.email, password: form.password});
    ...
    if (localCart.length > 0) {
      await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/cart`, 
        { items: localCart }, 
  ...
  return (
    <div className="md:min-h-screen flex items-center justify-center  md:mx-5 md:my-5 mx-10 my-20">
