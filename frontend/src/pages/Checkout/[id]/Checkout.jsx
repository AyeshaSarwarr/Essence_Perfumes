...
function Checkout() {
    ...
    const prepareCheckout = async () => {
      try {
        if (id) {
          ...
          const res = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/product/${id}`);
          const item = {
          ...
          const requests = storedCart.map(item => axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/product/${item.id}`));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/orders`, 
        { orderData, items }, 
